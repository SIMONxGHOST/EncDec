...
class CryptoEngine:
    ...
    @classmethod
    def decrypt_text(cls, encrypted_text: str, password: str, key_type: str,
...
class EncDecProApp:
    ...
    def __init__(self, root: Any):
        ...
        self._setup_ui()
        self.apply_theme()
        self.set_status("EncDec Studio Pro v5.0.0 (AES-256-GCM & Memory-Hard Scrypt) Ready", "info")
    ...
    def _setup_ui(self):
        ...
        badge_lbl = tk.Label(
            title_box, text=" v5.0 • AES-256-GCM ", font=self.font_status,
    ...
    def _build_benchmark_tab(self):
        ...
        spec_info = (
            "======================================================================\n"
            "  EncDec Studio Pro (v5.0.0) Security Architecture\n"
            "======================================================================\n"
